...
- `drafts/` — markdown drafts written by the write-article skill. Not public; the user reviews them before publishing.
...
- **write-article** — drafts an article from memory into `drafts/`; no pre-judgment.
